            ...
            <ul id="sidebarnav">
                ...
                @if (in_array(Auth::user()->role, ['Kasir', 'Admin']))
                    <li class="sidebar-item {{ Request::is('product*') ? 'selected' : '' }}">
                        <a class="sidebar-link {{ Request::is('product*') ? 'active' : '' }}"
                ...
                @if (Auth::user()->role == 'Admin')
                    <li class="sidebar-item {{ Request::is('brand*') ? 'selected' : '' }}">
                        <a class="sidebar-link {{ Request::is('brand*') ? 'active' : '' }}"
                            ...
                            <span><i class="ti ti-brand-appgallery"></i></span>
                            <span class="hide-menu">Brand</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ Request::is('supplier*') ? 'selected' : '' }}">
                        <a class="sidebar-link {{ Request::is('supplier*') ? 'active' : '' }}"
                ...
                @if (in_array(Auth::user()->role, ['Kasir', 'Admin']))
                    ...
                    <li class="sidebar-item {{ Request::is('transaction*') ? 'selected' : '' }}">
                        <a class="sidebar-link {{ Request::is('transaction*') ? 'active' : '' }}"
                            href="{{ route('transaction.index') }}" aria-expanded="false">
                            <span><i class="ti ti-heart-handshake"></i></span>
                            <span class="hide-menu">@if (in_array(Auth::user()->role, ['Admin']))Data @endif Pembayaran</span>
                        </a>
                    </li>
                @endif
